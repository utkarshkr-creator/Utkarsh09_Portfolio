    ...
    <Section id="experience" title="Experience" className="bg-transparent">
      <GlassCard className="max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start mb-4">
          <div>
            <h3 className="text-xl font-bold text-accent-primary dark:text-[#03DAC6] flex items-center gap-2">
              <FaBriefcase /> Frontend Developer Intern
            </h3>
            <p className="text-lg font-semibold text-text-primary dark:text-gray-100 mt-1">Easy Webs</p>
          </div>
          <p className="text-text-muted mt-2 md:mt-0 bg-white/5 px-3 py-1 rounded-full text-sm">Nov 2022 – Dec 2022</p>
        </div>
        <ul className="space-y-3">
          <li className="flex items-start gap-3 text-text-secondary dark:text-gray-300">
