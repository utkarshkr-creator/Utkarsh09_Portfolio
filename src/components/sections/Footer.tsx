    ...
    <footer className="py-12 border-t border-glass-border dark:border-t-2 dark:border-[#03DAC6] text-center bg-bg-primary dark:bg-[#0a0a0a]">
      <div className="container mx-auto px-6">
        <div className="flex justify-center gap-8 mb-6 flex-wrap">
          ...
          <a href="https://twitter.com/Utkarsh9401" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-text-secondary dark:text-gray-400 hover:text-accent-primary transition-colors">
            <FaTwitter /> Twitter
          </a>
          <a href="https://www.linkedin.com/in/utkarshkr09/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-text-secondary dark:text-gray-400 hover:text-accent-primary transition-colors">
            <FaLinkedin /> LinkedIn
          </a>
          <a href="mailto:2022krutkarsh@gmail.com" className="flex items-center gap-2 text-text-secondary dark:text-gray-400 hover:text-accent-primary transition-colors">
            <FaEnvelope /> Email
          </a>
