    ...
    <Section id="about" title="About Me">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <GlassCard className="relative overflow-hidden">
          ...
          <h3 className="text-2xl font-bold text-accent-primary mb-4">Who I Am</h3>
          <p className="text-lg leading-relaxed text-text-secondary mb-4">
            I'm a passionate software developer currently pursuing my Master's in Technology at <strong className="text-text-primary">IIIT Allahabad</strong>, where I'm maintaining a CGPA of 9.20. My journey in tech started during my undergraduate years at MIT Muzaffarpur, and since then, I've been driven by the challenge of building high-performance, scalable applications that solve real-world problems.
          </p>
          <p className="text-lg leading-relaxed text-text-secondary">
            With a strong foundation in <strong className="text-text-primary">full-stack development</strong> and <strong className="text-text-primary">competitive programming</strong>, I specialize in creating real-time distributed systems, implementing advanced cryptographic solutions, and designing microservices architectures. I'm equally comfortable working with cutting-edge technologies like WebRTC and WebSockets as I am diving deep into zero-knowledge proofs and blockchain development.
          </p>
        </GlassCard>

        {/* The Way I Am */}
        <div>
          <h3 className="text-2xl font-bold text-center mb-8 bg-clip-text text-transparent bg-gradient-to-r from-accent-primary to-accent-secondary">
            The Way I Am
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <GlassCard className="flex items-start gap-4 hover:bg-white/5 transition-colors">
              ...
              <div>
                <h4 className="text-xl font-bold text-accent-secondary mb-2">Problem Solver</h4>
            ...
            <GlassCard className="flex items-start gap-4 hover:bg-white/5 transition-colors">
              ...
              <div>
                <h4 className="text-xl font-bold text-accent-secondary mb-2">Builder</h4>
                <p className="text-text-secondary">
            ...
            <GlassCard className="flex items-start gap-4 hover:bg-white/5 transition-colors">
              ...
              <div>
                <h4 className="text-xl font-bold text-accent-secondary mb-2">Continuous Learner</h4>
                <p className="text-text-secondary">
            ...
            <GlassCard className="flex items-start gap-4 hover:bg-white/5 transition-colors">
              ...
              <div>
                <h4 className="text-xl font-bold text-accent-secondary mb-2">Team Player</h4>
                <p className="text-text-secondary">
